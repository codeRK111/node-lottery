...
module.exports = {
  ...
  "BIP32_DERIVED": process.env.BIP32_DERIVED_KEY || "xpub6AB4zJotydAFksqVk623mY7mf38r7HpVTViRKp6RarxNqVTw7XxkZcEViAdS1St7Dz1qTvBZCQ9xKnxDuUYjYh34YKdrmdiwBqzTLfdgTk4",
  //"AWS_SES_KEY": process.env.AWS_SES_KEY,
  //"AWS_SES_SECRET": process.env.AWS_SES_SECRET,
  //"CONTACT_EMAIL": process.env.CONTACT_EMAIL || "nitikesh@nitikesh.info",
